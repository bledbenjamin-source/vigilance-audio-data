...
# Lien permanent vers la ressource sur Data.gouv
URL_DIRECTE = "https://www.data.gouv.fr/fr/datasets/r/fffda7e9-0ea2-4c35-bba0-4496f3af935d"

def run():
    try:
        headers = {'User-Agent': 'Mozilla/5.0'}
        print("⏳ Téléchargement du fichier RPPS (extraction lourde)...")
        ...
        # Filtrage par CODE PROFESSION 26 (Audioprothésiste)
        ...
        for _, row in df_audio.iterrows():
            ...
            resultats.append({
                ...
                "entreprise": str(row.get("Raison sociale site", "NOM INCONNU")).upper(),
                "siret": str(row.get("Identifiant technique de la structure", "SIRET NON DISPONIBLE")),
